...
public interface FiForeignerMapper {
    ...
    @Insert({
        ...
        "#{sex,jdbcType=NUMERIC}, #{birthday,jdbcType=TIMESTAMP}, ",
        ...
        "#{expertEvidence,jdbcType=NUMERIC}, #{fkEeAttachmentId,jdbcType=VARCHAR}, ",
        "#{fkRpPermitId,jdbcType=VARCHAR}, #{fkInvitationId,jdbcType=VARCHAR}, ",
        "#{isHere,jdbcType=NUMERIC}, #{status,jdbcType=NUMERIC}, ",
        "#{createDate,jdbcType=TIMESTAMP}, #{editDate,jdbcType=TIMESTAMP}, ",
        "#{createUser,jdbcType=VARCHAR}, #{editUser,jdbcType=VARCHAR})"
    })
    ...
    @Results({
        ...
        @Result(column="SEX", property="sex", jdbcType=JdbcType.NUMERIC),
        ...
        @Result(column="EXPERT_EVIDENCE", property="expertEvidence", jdbcType=JdbcType.NUMERIC),
        ...
        @Result(column="IS_HERE", property="isHere", jdbcType=JdbcType.NUMERIC),
    ...
    @Select({
        ...
        "FK_INVITATION_ID, IS_HERE, STATUS, CREATE_DATE, EDIT_DATE, CREATE_USER, EDIT_USER",
        "from FI_FOREIGNER",
        "where ID = #{id,jdbcType=NUMERIC}"
    })
    @Results({
    ...
    @Update({
        ...
        "set NAME = #{name,jdbcType=VARCHAR},",
          ...
          "EXPERT_EVIDENCE = #{expertEvidence,jdbcType=NUMERIC},",
          ...
          "IS_HERE = #{isHere,jdbcType=NUMERIC},",
