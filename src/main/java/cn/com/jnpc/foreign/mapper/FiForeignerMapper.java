...
public interface FiForeignerMapper {
     ...
     * to the database table FI_FOREIGNER
     * 
     ...
     * @mbggenerated Tue Oct 22 15:45:16 CST 2013
     */
    @Delete({ "delete from FI_FOREIGNER", "where ID = #{id,jdbcType=DECIMAL}" })
    ...
    int updateByExampleSelective(@Param("record") FiForeigner record,
	    @Param("example") FiForeignerExample example);
    ...
    int updateByExample(@Param("record") FiForeigner record,
	    @Param("example") FiForeignerExample example);
     ...
     * @mbggenerated Tue Oct 22 15:45:16 CST 2013
     */
    @Update({ "update FI_FOREIGNER", "set NAME = #{name,jdbcType=VARCHAR},",
