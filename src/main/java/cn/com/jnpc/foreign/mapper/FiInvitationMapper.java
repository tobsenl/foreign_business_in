...
public interface FiInvitationMapper {
    ...
    int updateByExampleSelective(@Param("record") FiInvitation record, @Param("example") FiInvitationExample example);
    ...
    int updateByExample(@Param("record") FiInvitation record, @Param("example") FiInvitationExample example);
